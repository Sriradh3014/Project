...
if __name__ == "__main__":
    ...
    keys_to_insert = [1, 3, 7, 10, 11, 13, 14, 15, 18, 16,
                      19, 24, 25, 26, 21, 4, 5, 20, 22, 2, 17, 12, 6]
    ...
    keys_to_remove = [6, 13, 7, 4, 2, 16]

    for key in keys_to_remove:
        b_tree.remove(key)

    print(f"Traversal of tree after removing keys  {keys_to_remove}")
    b_tree.traverse()
